(function (root, factory) {
  ...
  function JobSupport(active) {
    this._state_0 = atomic_0(active ? EMPTY_ACTIVE : EMPTY_NEW);
    this.parentHandle_0 = null;
  }
  ...
  JobSupport.prototype.tryFinalizeCancellingState_0 = function (expect, proposedUpdate, mode) {
    ...
    if (this.tryFinalizeStateActually_0(expect, update, mode))
      return true;
    var error = AssertionError_init('Unexpected state: ' + toString(this._state_0.value) + ', expected: ' + expect + ', update: ' + update);
  ...
  JobSupport.prototype.tryFinalizeStateActually_0 = function (expect, update, mode) {
    ...
    if (!this._state_0.compareAndSet_xwzc9q$(expect, updateValue))
      return false;
  ...
  JobSupport.prototype.startInternal_0 = function (state) {
    if (Kotlin.isType(state, Empty)) {
      if (state.isActive)
        return 0;
      if (!this._state_0.compareAndSet_xwzc9q$(state, EMPTY_ACTIVE))
        return -1;
  ...
  JobSupport$HandleExceptionOp.prototype.perform_s8jyv4$ = function (affected) {
    ...
    if (job._state_0.compareAndSet_xwzc9q$(this, this.original)) {
  ...
  function AbstractSendChannel() {
    ...
    this.onCloseHandler_h5aadc$_0 = atomic_0(null);
  }
  ...
  AbstractSendChannel.prototype.invokeOnCloseHandler_quhfr8$_0 = function (cause) {
    var tmp$;
    var handler = this.onCloseHandler_h5aadc$_0.value;
    if (handler !== null && handler !== HANDLER_INVOKED && this.onCloseHandler_h5aadc$_0.compareAndSet_xwzc9q$(handler, HANDLER_INVOKED)) {
      (typeof (tmp$ = handler) === 'function' ? tmp$ : throwCCE())(cause);
    }
  };
  AbstractSendChannel.prototype.invokeOnClose_f05bi3$ = function (handler) {
    if (!this.onCloseHandler_h5aadc$_0.compareAndSet_xwzc9q$(null, handler)) {
      var value = this.onCloseHandler_h5aadc$_0.value;
      ...
      if (closedToken != null && this.onCloseHandler_h5aadc$_0.compareAndSet_xwzc9q$(handler, HANDLER_INVOKED)) {
